...
final class Linkforge_Admin {
    ...
    public function enqueue_assets( string $hook_suffix ): void {
        ...
        wp_localize_script( 'linkforge-admin', 'linkforgeAdmin', [
            ...
            'i18n'     => [
                ...
                'noLogs'              => __( 'No 404 errors recorded yet.', 'linkforge-404' ),
                'noRedirects'         => __( 'No redirects configured yet.', 'linkforge-404' ),
                'quickRedirect'       => __( 'Quick 301 →', 'linkforge-404' ),
                'deleteAction'        => __( 'Delete', 'linkforge-404' ),
                'confirmQuickRedirect'=> __( 'Create 301 redirect for "%s" → Homepage?', 'linkforge-404' ),
                'exportNginx'         => __( 'Nginx Rewrite Rules', 'linkforge-404' ),
                'exportHtaccess'      => __( '.htaccess Rewrite Rules', 'linkforge-404' ),
                'copied'              => __( 'Copied!', 'linkforge-404' ),
                'copyToClipboard'     => __( 'Copy to Clipboard', 'linkforge-404' ),
                'savedIndicator'      => __( '✓ Saved', 'linkforge-404' ),
                'tablesWarning'       => __( 'Database tables are being created. Please deactivate and reactivate the plugin, or visit a 404 page to trigger table creation, then reload this page.', 'linkforge-404' ),
            ],
        ] );
    }
    ...
    public function register_settings(): void {
        $settings = [
            ...
            'linkforge_redirect_all_home'    => [ 'type' => 'boolean', 'default' => false ],
            'linkforge_immediate_logging'    => [ 'type' => 'boolean', 'default' => true ],
        ];
